...
console.log(`Mango name: ${Fruit.name}, price: $${Fruit.price}`);
...
function sandwich(...items: string[]): void{
    console.log("My Resturant Menu:")
for(let i=0; i < items.length; i++){
    console.log(` + ${items[i]}`)
}
}
console.log("Let's Enjoyy..")
...
const myCar: bigcar = createCar( "city","civic", { color: "silver", year: "2020"});
console.log(myCar);
